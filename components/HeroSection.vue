      ...
      <div class="container mx-auto flex px-5 pb-24 lg:mb-16 items-center justify-center flex-col">
        <div class="text-center lg:w-2/3 w-full">
          ...
          <div class="flex justify-center">
            ...
            -teal-500 border-0 py-2 rounded-lg px-12 focus:outline-none bg-teal-600 rounded text-lg">Sign in</button>
            <button class="ml-4 inline-flex text-gray-700 rounded-lg bg-gray-200 border-0 py-2 px-12 text-teal-600 focus:outline-none hover:bg-gray-300 rounded text-lg">Sign up</button>
          </div>
        </div>
      </div>
    </div>
